...
const PESOS_SIMULACRO = {
    ...
    "te1": 6, "te2": 5, "te3": 5, "te4": 5, "te5": 6,
    "te6": 4, "te7": 3, "te8": 4, "te9": 5, "te10": 5,
    "te11": 2, "te12": 3, "te13": 2, "te14": 2, "te15": 2,
    "te16": 2, "te17": 3, "te18": 2, "te19": 1, "te20": 2,
    "te21": 2
};
...
// 9. --- SINCRONIZACIÓN EN LA NUBE DEL CEREBRO SRS (Método POST, sin límite de URL) ---
function sincronizarSRSCloud() {
    ...
    try {
        fetch(URL_APPS_SCRIPT, {
            ...
            body: JSON.stringify({
                action: "sync_srs",
                data: JSON.stringify(cerebroSRS)
            })
